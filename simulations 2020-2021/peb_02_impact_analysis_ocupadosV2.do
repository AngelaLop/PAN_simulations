...
foreach l of local lost {
	...
	local income  ipcf ipcf_`l' ipcf_PS20_`l' ipcf_PS1_1_`l'_1 ipcf_PS1_1_`l'_2
...
*----------5.3: Poverty impact 
	...
	local incomes  ipcf_ppp ipcf_ppp11_20_sin_covid ipcf_`l'_ppp ipcf_PS20_`l'_ppp ipcf_PS1_1_`l'_1_ppp  ipcf_PS1_1_`l'_2_ppp 		// <------------- 	INCOMES POVERTY CALCUL!
	local bono = 0 
...
export excel using "C:\Users\WB585318\OneDrive - Universidad de los Andes\WB\Panama\output\impact_no_ps.xlsx", sh("Results_conRamas_22", replace)  firstrow(var)
